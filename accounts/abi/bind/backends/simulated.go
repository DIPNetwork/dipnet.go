...
import (
	...
	"github.com/DIPNetwork/dipnet.go"
	...
	"github.com/DIPNetwork/dipnet.go/consensus/ethash"
...
func (b *SimulatedBackend) callContract(ctx context.Context, call ethereum.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, bool, error) {
	...
	ret, gasUsed, _, failed, err := core.NewStateTransition(vmenv, msg, gaspool, nil, nil, 0).TransitionDb()
